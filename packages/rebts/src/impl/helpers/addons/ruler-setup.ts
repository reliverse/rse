...
// https://github.com/AmanVarshney01/create-better-t-stack/blob/main/apps/cli/src/helpers/addons/ruler-setup.ts
...
export async function setupRuler(config: ProjectConfig) {
  ...
  try {
    ...
    const currentConfig = await fs.readFile(configFile, { encoding: "utf-8" });
