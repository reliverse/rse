...
// https://github.com/AmanVarshney01/create-better-t-stack/blob/main/apps/cli/src/utils/setup-catalogs.ts
...
async function setupPnpmCatalogs(
  ...
  const workspaceContent = await fs.readFile(workspaceYamlPath, {
    encoding: "utf-8",
  });
