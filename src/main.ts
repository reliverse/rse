...
const main = defineCommand({
  ...
  subCommands: {
    ...
    add: () => import("./arg/add/add-mod.js").then((r) => r.default),
    ai: () => import("./arg/ai/ai-mod.js").then((r) => r.default),
    clone: () => import("./arg/clone/clone-mod.js").then((r) => r.default),
    cmod: () => import("./arg/cmod/cmod-mod.js").then((r) => r.default),
    env: () => import("./arg/env/env-mod.js").then((r) => r.default),
    help: () => import("./arg/help/help-mod.js").then((r) => r.default),
    init: () => import("./arg/init/init-mod.js").then((r) => r.default),
