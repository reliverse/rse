...
// https://github.com/AmanVarshney01/create-better-t-stack/blob/main/apps/cli/src/utils/compatibility-rules.ts
...
export function validateSelfBackendCompatibility(
  ...
  if (backend === "self") {
    ...
    const hasSupportedWeb =
      web.length === 1 &&
      FULLSTACK_FRONTENDS.includes(web.at(0) as (typeof web)[number]);
